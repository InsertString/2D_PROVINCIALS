...
void flag_auto(int colour) {
  switch (auto_step) {
    ...
    break;
    case  9 :
    i = chassis.PID_drive(550, 100);

    if (chassis.right_pos() > 500)
      flipper.move_absolute(-330, 100);
    ...
    break;
    case 12 :
    i = chassis.PID_turn(-490, 100);
    if (i == COMPLETE) {
      advance_auto_step();
    }
    break;
    case 13 :
    i = chassis.PID_drive(2300, 100);
    if (i == COMPLETE) {
      advance_auto_step();
    }
    break;
    case 14 :
    i = chassis.PID_turn(1100, 100);
    if (i == COMPLETE) {
      advance_auto_step();
    }
    break;
    ...
    break;
    case 17 :
    i = chassis.PID_drive(2200, 100);
    if (i == COMPLETE) {
      advance_auto_step();
    }
    break;
    case 18 :
    i = chassis.PID_drive(600, 50);
    if (i == COMPLETE) {
      ball_system.setIntakePower(127);
      advance_auto_step();
    }
